# SvobodaWeb TypeScript SDK Reference

Complete API reference for the SvobodaWeb TypeScript SDK.
...
```ts
new SvobodaWebSDK(options?: object)
```
...
#### `SvobodaWebSDK.test(testopts?, sdkopts?)`
...
**Returns:** `SvobodaWebSDK` instance in test mode.
...
Return the parent `SvobodaWebSDK` instance.
