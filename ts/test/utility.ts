...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.SVOBODAWEB_TEST_LIVE ||
    'TRUE' === process.env.SVOBODAWEB_TEST_OVERRIDE
  ) {
  ...
  m.SVOBODAWEB_TEST_EXPLAIN = process.env.SVOBODAWEB_TEST_EXPLAIN || m.SVOBODAWEB_TEST_EXPLAIN
