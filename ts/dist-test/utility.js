...
function envOverride(m) {
    if ('TRUE' === process.env.SVOBODA_WEB_TEST_LIVE ||
        'TRUE' === process.env.SVOBODA_WEB_TEST_OVERRIDE) {
    ...
    m.SVOBODA_WEB_TEST_EXPLAIN = process.env.SVOBODA_WEB_TEST_EXPLAIN || m.SVOBODA_WEB_TEST_EXPLAIN;
    return m;
}
