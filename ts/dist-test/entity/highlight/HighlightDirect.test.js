...
(0, node_test_1.describe)('HighlightDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SvobodaWebSDK({
...
function liveScenariosActive() { return false && process.env.SVOBODA_WEB_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SvobodaWebSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SVOBODA_WEB_TEST_HIGHLIGHT_ENTID'];
    ...
    const client = new __1.SvobodaWebSDK({
        base: 'http://localhost:8080',
