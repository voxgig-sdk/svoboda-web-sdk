...
// SvobodaWeb SDK timeout feature
...
class SvobodaWebTimeoutFeature extends SvobodaWebBaseFeature
{
    ...
    private function _with_timeout(SvobodaWebContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SvobodaWebContext $_ctx, float $ms): void
    {
        $client = $this->client;
