...
class SvobodaWebRbacFeature extends SvobodaWebBaseFeature
{
    ...
    private function _required(SvobodaWebContext $ctx): ?string
    {
    ...
    private function _reject(SvobodaWebContext $ctx, string $required): void
    {
    ...
    private function _track(SvobodaWebContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
