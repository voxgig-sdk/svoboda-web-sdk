...
class SvobodaWebCacheFeature extends SvobodaWebBaseFeature
{
    ...
    private function _through(SvobodaWebContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
