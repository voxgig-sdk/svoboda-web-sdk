...
// SvobodaWeb SDK clienttrack feature
...
class SvobodaWebClienttrackFeature extends SvobodaWebBaseFeature
{
    ...
    public function PostConstruct(SvobodaWebContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SvobodaWeb-SDK';
