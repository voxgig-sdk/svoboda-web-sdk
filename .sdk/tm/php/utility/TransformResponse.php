...
// SvobodaWeb SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SvobodaWebTransformResponse
{
    public static function call(SvobodaWebContext $ctx): mixed
    {
        ...
        $transform = SvobodaWebHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
