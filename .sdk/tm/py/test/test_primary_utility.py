...
from projectname_sdk import SvobodaWebSDK
from projectname_sdk.core.spec import SvobodaWebSpec
from projectname_sdk.core.result import SvobodaWebResult
from projectname_sdk.core.response import SvobodaWebResponse
from projectname_sdk.core.operation import SvobodaWebOperation
from projectname_sdk.core.error import SvobodaWebError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import SvobodaWebBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return SvobodaWebError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = SvobodaWebSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = SvobodaWebSDK.test(None, None)
        ...
        class TestInitFeature(SvobodaWebBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(SvobodaWebBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = SvobodaWebSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = SvobodaWebSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = SvobodaWebSDK.test(None, setup_opts)
