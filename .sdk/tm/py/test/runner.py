...
class SvobodaWebTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SvobodaWebTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SvobodaWebTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SvobodaWebTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
