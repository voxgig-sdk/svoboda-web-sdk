...
class SvobodaWebTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SvobodaWebTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SvobodaWebTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SvobodaWebTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
