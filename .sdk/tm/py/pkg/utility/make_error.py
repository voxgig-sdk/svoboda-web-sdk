# SvobodaWeb SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, SvobodaWebError):
        errmsg = err.msg
    ...
    msg = "SvobodaWebSDK: " + opname + ": " + errmsg
    ...
    sdk_err = SvobodaWebError("", msg, ctx)
