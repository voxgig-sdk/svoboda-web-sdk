...
from projectname_sdk.core.control import SvobodaWebControl
...
class SvobodaWebContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, SvobodaWebSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SvobodaWebResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SvobodaWebResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SvobodaWebError(code, msg, self)
