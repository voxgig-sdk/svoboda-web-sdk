...
|---|---|---|
| `ts/` | @voxgig-sdk/svoboda-web-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/svoboda-web-sdk \
      --repository voxgig-sdk/svoboda-web-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/svoboda-web-sdk` shows it, and
`npm trust revoke @voxgig-sdk/svoboda-web-sdk --id=<id>` removes it.
