...
class HighlightEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SVOBODAWEB_TEST_HIGHLIGHT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def highlight_basic_setup(extra)
  ...
  entid_env_raw = ENV["SVOBODAWEB_TEST_HIGHLIGHT_ENTID"]
