...
type Args struct {
	Entity string         `json:"entity" jsonschema:"highlight"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SvobodaWebSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "svoboda-web_list",
		Description: "List records from SvobodaWeb. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "svoboda-web_load",
		Description: "Load a single record from SvobodaWeb. " +
...
func runOp(client *sdk.SvobodaWebSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SvobodaWebSDK, name string) (sdk.SvobodaWebEntity, error) {
