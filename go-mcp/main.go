// Command SvobodaWeb-mcp is an MCP server exposing the SvobodaWeb
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SvobodaWeb_list  — list records of an entity
//	SvobodaWeb_load  — load a single record of an entity
//
