...
function runner.env_override(m)
  local live = runner.getenv("SVOBODA_WEB_TEST_LIVE")
  local override = runner.getenv("SVOBODA_WEB_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SVOBODA_WEB_TEST_EXPLAIN")
