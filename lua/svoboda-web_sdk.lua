...
local SvobodaWebSDK = {}
SvobodaWebSDK.__index = SvobodaWebSDK
...
SvobodaWebSDK._make_feature = _make_feature


function SvobodaWebSDK.new(options)
  local self = setmetatable({}, SvobodaWebSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function SvobodaWebSDK:options_map()
...
function SvobodaWebSDK:get_utility()
  return Utility.copy(self._utility)
end


function SvobodaWebSDK:get_root_ctx()
  return self._rootctx
end


function SvobodaWebSDK:prepare(fetchargs)
...
function SvobodaWebSDK:direct(fetchargs)
...
-- by passing it.
function SvobodaWebSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function SvobodaWebSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "SvobodaWebSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function SvobodaWebSDK:Highlight(data)
...
function SvobodaWebSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = SvobodaWebSDK.new(sdkopts)
  sdk.mode = "test"
