...
func registerSDKWords(r *eng.Registry, client *sdk.SvobodaWebSDK) {
...
func runOp(client *sdk.SvobodaWebSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
