...
// SvobodaWeb SDK utility: graphql
//
...
class SvobodaWebGraphql
{
    ...
    // equivalent.
    public static function body(SvobodaWebContext $ctx): mixed
    {
    ...
    public static function errors(SvobodaWebContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
