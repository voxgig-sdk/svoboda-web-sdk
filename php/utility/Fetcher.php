...
// SvobodaWeb SDK utility: fetcher

class SvobodaWebFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SvobodaWebSDK/1.0)';
    ...
    public static function call(SvobodaWebContext $ctx, string $fullurl, array $fetchdef): array
    {
