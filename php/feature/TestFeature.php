...
// SvobodaWeb SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SvobodaWebTestFeature extends SvobodaWebBaseFeature
{
    ...
    public function init(SvobodaWebContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SvobodaWebContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = SvobodaWebParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SvobodaWebContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SvobodaWebContext $ctx, $op, $args): array
    {
