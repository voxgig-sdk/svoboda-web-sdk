...
// SvobodaWeb SDK ratelimit feature
...
class SvobodaWebRatelimitFeature extends SvobodaWebBaseFeature
{
    ...
    private function _acquire(SvobodaWebContext $ctx): void
    {
    ...
    private function _track(SvobodaWebContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
