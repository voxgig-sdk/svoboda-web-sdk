...
class SvobodaWebProxyFeature extends SvobodaWebBaseFeature
{
    ...
    public function init(SvobodaWebContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SvobodaWebContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
