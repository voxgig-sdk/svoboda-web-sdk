...
class SvobodaWebNetsimFeature extends SvobodaWebBaseFeature
{
    ...
    private function _simulate(SvobodaWebContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SvobodaWebContext $ctx, array $applied): void
    {
        $client = $this->client;
