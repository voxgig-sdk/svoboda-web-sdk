...
// SvobodaWeb SDK idempotency feature
...
class SvobodaWebIdempotencyFeature extends SvobodaWebBaseFeature
{
    ...
    private function _mutating(SvobodaWebContext $ctx): bool
    {
