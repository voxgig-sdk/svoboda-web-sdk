...
// SvobodaWeb SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SvobodaWebOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SvobodaWebOmni::structfix($now, Struct::undef()))
                        !== json_encode(SvobodaWebOmni::structfix($val, Struct::undef()))) {
