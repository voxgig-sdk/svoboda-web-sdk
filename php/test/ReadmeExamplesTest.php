...
// SvobodaWeb SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SvobodaWebSDK::test)
...
{
    private const SDK_CLASS = 'SvobodaWebSDK';
    ...
    private const SDK_BASE = 'svobodaweb_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../svobodaweb_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
