...
Results: Successful response with live highlights data.
...
| --- | --- | --- | --- |
| Highlight | `list` | `GET /hljson` | See reference |

## Connect to the API

- Production server: `https://www.svoboda.org`
...
- `svoboda-web_list`: List records for an entity. Supported entities: `highlight`.
- `svoboda-web_load`: Load one record for an entity. No active entity supports this operation.
