...
class SvobodaWebTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SvobodaWebTestRunner.getenv("SVOBODAWEB_TEST_LIVE")
        override = SvobodaWebTestRunner.getenv("SVOBODAWEB_TEST_OVERRIDE")
        ...
        explain = SvobodaWebTestRunner.getenv("SVOBODAWEB_TEST_EXPLAIN")
