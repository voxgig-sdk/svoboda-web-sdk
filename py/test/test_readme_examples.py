# SvobodaWeb SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SvobodaWebSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SvobodaWebSDK(...) and SvobodaWebSDK.test(...) become
#      SvobodaWebSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "svobodaweb_sdk"
_SDK_CLASS = "SvobodaWebSDK"
