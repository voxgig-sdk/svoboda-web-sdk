...
from svobodaweb_sdk.utility import register

# Load features
from svobodaweb_sdk.feature.base_feature import SvobodaWebBaseFeature
from svobodaweb_sdk.features import _has_feature, _make_feature
...
class SvobodaWebSDK:
    ...
    def get_utility(self):
        return SvobodaWebUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SvobodaWebSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Highlight(self, data=None) -> "HighlightEntity":
        ...
        from svobodaweb_sdk.entity.highlight_entity import HighlightEntity
        return HighlightEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "SvobodaWebSDK":
        if sdkopts is None:
            sdkopts = {}
